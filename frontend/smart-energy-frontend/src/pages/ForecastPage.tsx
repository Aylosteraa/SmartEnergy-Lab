  ...
  const loadForecastData = async () => {
    ...
    try {
      ...
      const [
        ...
        fetch(
          "http://localhost:8000/forecast/24h"
        ),

        fetch(
          "http://localhost:8000/forecast/7d"
        ),

        fetch(
          "http://localhost:8000/forecast/month"
        ),
                  ...
                  {forecastMonth.map(
                    (item, index) => (
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          {item.total_consumption} kWh
                        </td>


                        <td>
                          {item.solar_consumption} kWh
                        </td>


                        <td>
                          {item.battery_consumption} kWh
                        </td>


                        <td>
                          {item.solar_generation} kWh
                        </td>
